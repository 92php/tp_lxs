...
<body>
	...
	<form action="<?php echo U('runSaveNews');?>" method='post'>
		<table class="table">
			<tr>
			...
			<tr>
				...
				<td>
					<select name="type" id="">
					<option value="<?php echo ($news["0"]["type"]); ?>"><?php echo ($news["0"]["type"]); ?></option>
			...
			<tr>
				<td colspan="2" width='10%'>
					<textarea id='content' name='content' cols="140" rows="30"><?php echo ($news["0"]["content"]); ?></textarea>
				</td>
			</tr>
			<tr>
				<td colspan='2'>
