...
<body>
	...
	<table class="table">
		<?php if(isset($buddhist) && !$buddhist): ?><tr>
				<td align='center'><img src='__PUBLIC__/Images/noseach.jpg'/>没有检索到相关佛事</td>
			</tr>
		<?php else: ?>
			<tr>
			<th>ID</th>
			...
			<?php if(is_array($buddhist)): foreach($buddhist as $key=>$v): ?><tr>
				<td><?php echo ($v["id"]); ?></td>
