	...
	<div class="login_inpt">
		...
		<form action="<?php echo U(GROUP_NAME.'/Login/login');?>" method="post">
			<ul>
				...
				<li><span>密　码：</span><input type='password' name="password" /><span id="lei"><a href="<?php echo U(GROUP_NAME.'/Index/editPwd');?>">&nbsp;忘记密码？</a></span></li>
				<li><span>验证码：</span><input type='text' name="yzm" id="yzm"/><span id="lei"><img style='margin-left:8px;' src="<?php echo U(GROUP_NAME.'/Login/yzm');?>"  onclick='ch(this)'/></span></li>
				...
				<li id="zhao">您还可以：<a href="<?php echo U(GROUP_NAME.'/Index/editPwd');?>">找回密码</a>或<a href="<?php echo U(GROUP_NAME.'/Index/register');?>">免费注册</a></li>
			</ul>
		</form>
	</div>
</div>
