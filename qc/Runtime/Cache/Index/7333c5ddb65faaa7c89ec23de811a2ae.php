<?php if (!defined('THINK_PATH')) exit();?><title><?php echo ($system["0"]["WEBNAME"]); ?></title>
...
<div class="hotel">
	...
	<div class="hotel_list">
		<div class="list">
			<?php if(is_array($Attr)): $i = 0; $__LIST__ = $Attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><ul>
			<div class="list_con">
				<li><a href="<?php echo U(GROUP_NAME.'/Attractions/attrShow', array('id' => $v['id']));?>"><img src='<?php if($v["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($v["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></a><p class="list_word"><a href="<?php echo U(GROUP_NAME.'/Attractions/attrShow', array('id' => $v['id']));?>" id="word_p"><?php if($v["title"]): echo ($v["title"]); else: ?>产品展示<?php endif; ?></a><a href="<?php echo U(GROUP_NAME.'/Attractions/attrShow', array('id' => $v['id']));?>" id="img_a"><img src="__PUBLIC__/images/images/read_more.jpg" id="go"/></a></p></li>
			</div>
