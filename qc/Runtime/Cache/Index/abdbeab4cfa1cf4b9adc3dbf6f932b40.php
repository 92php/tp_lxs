...
<div class="hotel">
	<!--当前位置 start-->
	<div class="xianlu_option"><h6>当前位置：&nbsp;<a href="__GROUP__">首页</a>&nbsp; &raquo;&nbsp;<a href="<?php echo U(GROUP_NAME.'/Circuit/index');?>">线路预定</a></h6></div>
	<!--当前位置 end-->
	<!--内容 start-->
	<div class="hotelcontent">
	<div class="hotel_content">
		<div class="xianlu_option_top"><h6><a href=""><?php echo ($list["region"]); ?>预定</a></h6></div>
		<div class="cont_main">
			<h1><a href=""><?php echo ($list["title"]); ?></a></h1>
			<div class="cont_yud">
				<div class="xianlu_locatin">
					<span>出发城市：</span>
					<a href=""><?php echo ($list["city"]); ?></a>
				</div>
				<div class="xianlu_price">
					<span>行程天数：</span>
					<a href=""><?php echo ($list["tourtime"]); ?>&nbsp;天</a>
				</div>
				<div class="xianlu_grade">
					<span>交通方式：</span>
					<a href=""><?php echo ($list["transportation"]); ?></a>
				</div>
				<div class="xianlu_yudtel">
					<span>预定电话：</span>
					<a href=""><?php echo ($list["telme"]); ?></a>
				</div>
			...
			<div id="myModal" class="reveal-modal">
				<h2>预定表单</h2>
				<form action="<?php echo U(GROUP_NAME.'/Circuit/ciryud');?>" method="post">
				<p>线路名称：<input name="title" type="text" class="input" size="20" value="<?php echo ($list["title"]); ?>"></p>
				...
				<p>预定人数：<input name="shu" type="text" class="input" size="35" value=""></p>
				<p>　　备注：<textarea class="input" name="note" style="width:180px; height:70px;"></textarea></p>
				<input type="hidden" name='type' value='线路订单'/>
			...
			<div class="con">
				...
				<div class="page"><p style="width:340px; margin-left:0px;">上一篇：<a href="<?php echo U(GROUP_NAME.'/Circuit/cirShow', array('id' => $prev['id']));?>"><?php if($prev): echo ($prev["title"]); else: ?>没有了<?php endif; ?></a></p><p style="width:340px; margin-right:0px;
				margin-top:-37px;">下一篇：<a href="<?php echo U(GROUP_NAME.'/Circuit/cirShow', array('id' => $next['id']));?>"><?php if($next): echo ($next["title"]); else: ?>没有了<?php endif; ?></a></p></div>
	</div>
	<div class="righthotel">
		<div class="righthotel_title"><h2><a href="">推荐线路</a></h2></div>
		<div class="righthotel_list">
			<ul>
				<?php if(is_array($tuijie)): $i = 0; $__LIST__ = $tuijie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U(GROUP_NAME.'/Circuit/cirShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
	<div class="callme">
