...
<div class="hotel">
	<!--当前位置 start-->
	<div class="zuche_option"><input type='text' name='zuche' class="seach_zuche"/><input  type="submit" value="搜索" class="seach_sub"/><h6>当前位置：&nbsp;<a href="__GROUP__">首页</a>&nbsp; &raquo;&nbsp;<a href="#">旅游租车</a></h6></div>
	<!--当前位置 end-->
	<div class="zuche_adv"><img src="__PUBLIC__/images/images/zhuche.jpg"/></div>
	<!--内容 start-->
	<div class="zuchecontent">
	<div class="zuche_content">
		<div class="zuche_cont_top"><h6><a href=""><?php echo ($list["title"]); ?>车型展示</a></h6></div>
		<div class="cont_main">
			<h1><a href=""><?php echo ($list["title"]); ?></a></h1>
			<div class="cont_yud">
				<div class="locatin">
					<span>区&nbsp;&nbsp;域：</span>
					<a href=""><?php echo ($list["city"]); ?></a>
				</div>
				<div class="price">
					<span>价&nbsp;&nbsp;格：</span>
			...
			<div id="myModal" class="reveal-modal">
				<h2>预定表单</h2>
				<form action="<?php echo U(GROUP_NAME.'/Carhire/zuCheYud');?>" method="post">
				<p>车型名称：<input name="title" type="text" class="input" size="20" value="<?php echo ($list["models"]); ?>"></p>
				<p>取车时间：<input class="Wdate" type="text" onClick="WdatePicker()" name="startime" style="width:180px;height:30px;"> </p>
			    <p>还车时间：<input class="Wdate" type="text" onClick="WdatePicker()" name="endtime" style="width:180px;height:30px;"> </p>
			...
			<div class="con">
				...
				<div class="page"><p style="width:340px; margin-left:0px;">上一篇：<a href="<?php echo U(GROUP_NAME.'/Carhire/carShow', array('id' => $prev['id']));?>"><?php if($prev): echo ($prev["title"]); else: ?>没有了<?php endif; ?></a></p><p style="width:340px; margin-right:0px;
				margin-top:-37px;">下一篇：<a href="<?php echo U(GROUP_NAME.'/Carhire/carShow', array('id' => $next['id']));?>"><?php if($next): echo ($next["title"]); else: ?>没有了<?php endif; ?></a></p></div>
	</div>
	<div class="rightche">
		<div class="righthotel_title"><h2><a href="">推荐车型</a></h2></div>
		<div class="righthotel_list">
			<ul>
				<?php if(is_array($tuijie)): $i = 0; $__LIST__ = array_slice($tuijie,1,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U(GROUP_NAME.'/Carhire/carShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
	<div class="callmeche">
