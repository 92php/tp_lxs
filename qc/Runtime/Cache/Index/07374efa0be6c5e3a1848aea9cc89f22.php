...
<div class="hotel">
	...
	<div class="hotel_content">
		<div class="foshi_cont_top"><h6><a href=""><?php echo ($list["0"]["fenlei"]); ?></a></h6></div>
		<div class="fenlei_list">
			
						<ul>
							<?php if($list): if(is_array($list)): foreach($list as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Category/cateShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a><span><a href="">[<?php echo (date('Y-m-d', $v["addtime"])); ?>]</a></span></li><?php endforeach; endif; ?>
							<?php else: ?>暂无内容<?php endif; ?>
						</ul>
					
		</div>
		<div class="page"><p><?php echo ($page); ?></p></div>
	</div>
