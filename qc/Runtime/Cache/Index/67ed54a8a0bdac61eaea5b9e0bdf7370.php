...
<div class="hotel">
	...
	<div class="hotel_list">
		<div class="list">
			...
			<div class="list_con">
				<li><a href="<?php echo U(GROUP_NAME.'/Goods/shopShow', array('id' => $v['id']));?>"><img src='<?php if($v["picmax"]): ?>__ROOT__/uploads/Pic/<?php echo ($v["picmax"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></a><p class="list_word"><a href="<?php echo U(GROUP_NAME.'/Goods/shopShow', array('id' => $v['id']));?>" id="word_p"><?php if($v["name"]): echo ($v["name"]); else: ?>产品展示<?php endif; ?></a><a href="<?php echo U(GROUP_NAME.'/Goods/shopShow', array('id' => $v['id']));?>" id="img_a"><img src="__PUBLIC__/images/images/read_more.jpg" id="go"/></a></p></li>
			</div>
