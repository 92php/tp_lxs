...
<div class="hotel">
	...
	<!--当前位置 end-->
	<!--条件搜索 start-->
	<div class="hotel_seach">
					 <dl id="manuItem" class="xianlu_clear">
					<dt>区&nbsp;&nbsp;&nbsp;&nbsp;域：</dt>
					<dd class="xianlu_brand-sel-box">
					<div id="singular" class="xianlu_brand-list">
                                <span class="xianlu_allsel">不限</span>
                                <a style="background-color: #009900;color: #FFFFFF;" href="">联想</a>
                                <a href="">华硕</a>
                                <a href="">惠普</a>
                                <a href="">戴尔</a>
                                <a href="">神舟</a>
   ...
   <dl id="manuItem" class="xianlu_clear">
            ...
            <dl id="manuItem" class="xianlu_clear">
					...
					<div id="singular" class="xianlu_brand-list">
					 ...
					 <div class="xianlu_order">
					 	 <dl id="manuItem" class="xianlu_orderclear">
					<dt>排&nbsp;&nbsp;&nbsp;&nbsp;序：</dt>
					<dd class="xianlu_orderbrand-sel-box">
					<div id="singular" class="xianlu_orderbrand-list">
                                <span class="xianlu_orderallsel">不限</span>
                                 <a href="">联想</a>
                                <a href="">华硕</a>
                                <a href="">惠普</a>
                                <a href="">戴尔</a>
