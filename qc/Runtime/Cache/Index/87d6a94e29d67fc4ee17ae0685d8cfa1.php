...
<!-- 主体开始 -->
<div class="editPwds" style="margin-bottom: 40px;">
	<div class="editPwd_bjpic"><p>您还不是我们的会员？</p><a href="<?php echo U(GROUP_NAME.'/Index/register');?>">免费注册</a></div>
	<div class="register_inpt">
		<form action="<?php echo U(GROUP_NAME.'/Index/runEditPwd');?>" method="post">
			<ul>
				<li><span>登录账号：</span><input type='text' name="email" /><span id="lei"><a href="">&nbsp;注册时填写的邮箱名称</a></span></li>
				<li><span>手机号码：</span><input type='text' name="phone" /><span id="lei"><a href="">&nbsp;注册时填写的手机号码</a></span></li>
				<li><span>设置密码：</span><input type='password' name="pwd" /><span id="lei"><a href="">&nbsp;6位以上字符</a></span></li>
