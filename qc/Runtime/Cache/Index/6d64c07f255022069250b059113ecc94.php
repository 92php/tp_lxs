...
<div class="hotel">
	<!--当前位置 start-->
	<div class="foshi_option"><h6>当前位置：&nbsp;<a href="__GROUP__">首页</a>&nbsp; &raquo;&nbsp;<a href="<?php echo U(GROUP_NAME.'/Buddhist/index');?>">佛事活动</a></h6></div>
	<!--当前位置 end-->
	<!--内容 start-->
	<div class="hotelcontent">
	<div class="hotel_content">
		<div class="foshi_cont_top"><h6><a href="">佛事活动展示</a></h6></div>
		<div class="cont_main">
			<h1><a href=""><?php echo ($list["title"]); ?></a></h1>
			
				
					<div class="yudimg"><a style="display:block;width:300px;margin:50px auto;text-align:center;font-size:18px;color:#5e5e5e;text-decoration:none; margin-top:100px; margin-left:-320px;" href="javascript:void(0);" data-reveal-id="myModal"><img src="__PUBLIC__/images/images/me_yud.jpg" /></a></div>
			
			<!--弹出框-->
			<div id="myModal" class="reveal-modal">
				<h2>预定表单</h2>
				<form action="<?php echo U(GROUP_NAME.'/Buddhist/buddYud');?>" method="post">
				<p>佛事名称：<input name="title" type="text" class="input" size="20" value="<?php echo ($list["title"]); ?>"></p>
				...
				<p>参会时间：<input class="Wdate" type="text" onClick="WdatePicker()" name="startime" style="width:180px;height:30px;"> </p>
				<input type="hidden" name='type' value='佛事订单'/>
			...
			<div class="con">
				...
				<div class="page"><p style="width:340px; margin-left:0px;">上一篇：<a href="<?php echo U(GROUP_NAME.'/Buddhist/buddShow', array('id' => $prev['id']));?>"><?php if($prev): echo ($prev["title"]); else: ?>没有了<?php endif; ?></a></p><p style="width:340px; margin-right:0px;
				margin-top:-37px;">下一篇：<a href="<?php echo U(GROUP_NAME.'/Buddhist/buddShow', array('id' => $next['id']));?>"><?php if($next): echo ($next["title"]); else: ?>没有了<?php endif; ?></a></p></div>
	</div>
	<div class="righthotel">
		<div class="righthotel_title"><h2><a href="">推荐佛事</a></h2></div>
		<div class="righthotel_list">
			<ul>
				<?php if(is_array($tuijie)): $i = 0; $__LIST__ = array_slice($tuijie,1,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U(GROUP_NAME.'/Buddhist/buddShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
	<div class="callme">
