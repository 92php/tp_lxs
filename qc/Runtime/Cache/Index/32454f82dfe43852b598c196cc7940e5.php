...
<div class="hotel">
	<!--当前位置 start-->
	<div class="hotel_option"><h6>当前位置：&nbsp;<a href="__GROUP__">首页</a>&nbsp; &raquo;&nbsp;<a href="<?php echo U(GROUP_NAME.'/Hotel/index');?>">酒店预定</a></h6></div>
	<!--当前位置 end-->
	<!--条件搜索 start-->
	...
	<div class="hotel_list">
		<div class="list">
			...
			<div class="list_con">
				<li><a href="<?php echo U(GROUP_NAME.'/Hotel/hotelShow', array('id' => $v['id']));?>"><img src='<?php if($v["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($v["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></a><p class="list_word"><a href="<?php echo U(GROUP_NAME.'/Hotel/hotelShow', array('id' => $v['id']));?>" id="word_p"><?php if($v["title"]): echo ($v["title"]); else: ?>产品展示<?php endif; ?></a><a href="<?php echo U(GROUP_NAME.'/Hotel/hotelShow', array('id' => $v['id']));?>" id="img_a"><img src="__PUBLIC__/images/images/read_more.jpg" id="go"/></a></p></li>
			</div>
