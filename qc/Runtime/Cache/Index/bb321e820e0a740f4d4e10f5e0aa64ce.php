...
<div class="hotel">
	<!--当前位置 start-->
	<div class="shop_option"><h6>当前位置：&nbsp;<a href="__GROUP__">首页</a>&nbsp; &raquo;&nbsp;<a href="<?php echo U(GROUP_NAME.'/Shop/index');?>">网上商城</a></h6></div>
	<!--当前位置 end-->
	<!--内容 start-->
	...
	<div class="hotel_content">
		...
		<div class="cont_main">
			<h1><a href=""><?php echo ($list["name"]); ?></a></h1>
				...
				<div class="conimg"><a href=""><img src="__PUBLIC__/images/images/me_yud.jpg"/></a></div>
		</div>
				<div class="page"><p style="width:340px; margin-left:0px;">上一篇：<a href="<?php echo U(GROUP_NAME.'/Shop/shopShow', array('id' => $prev['id']));?>"><?php if($prev): echo ($prev["name"]); else: ?>没有了<?php endif; ?></a></p><p style="width:340px; margin-right:0px;
				margin-top:-37px;">下一篇：<a href="<?php echo U(GROUP_NAME.'/Shop/shopShow', array('id' => $next['id']));?>"><?php if($next): echo ($next["name"]); else: ?>没有了<?php endif; ?></a></p></div>
	</div>
	<div class="righthotel">
		<div class="righthotel_title"><h2><a href="">推荐商品</a></h2></div>
		<div class="righthotel_list">
			<ul>
				<?php if(is_array($tuijie)): $i = 0; $__LIST__ = array_slice($tuijie,1,9,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U(GROUP_NAME.'/Shop/shopShow', array('id' => $v['id']));?>"><?php echo ($v["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
		</div>
	</div>
	<div class="callme">
