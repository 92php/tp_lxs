...
<div class="hotel">
	<!--当前位置 start-->
	<div class="huiyi_option"><h5><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' => '1'));?>">会议选址</a><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'2'));?>">会议策划</a><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' => '3'));?>">会议接待</a><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'4'));?>">会议酒店</a><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'5'));?>">会议设施</a></h5><h6>当前位置：&nbsp;<a href="__GROUP__">首页</a>&nbsp; &raquo;&nbsp;<a href="<?php echo U(GROUP_NAME.'/Category/index');?>">商务会议</a></h6></div>
	<!--当前位置 end-->
	
	<!--内容 start-->
		<!---第一行--->
		<div class="xuanzhi">
			<div class="huiyi_read"><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' => '1'));?>"><img src="__PUBLIC__/images/images/huiyi_more_read.jpg"/></a></div>
			<div class="huiyi_neir">
				<div class="huiyi_img"><img src='<?php if($xuanzhi["0"]["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($xuanzhi["0"]["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></div>
					<div class="huiyi_list">
						<ul>
						<?php if($xuanzhi): if(is_array($xuanzhi)): foreach($xuanzhi as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Category/cateShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a><span><a href="">[<?php echo (date('Y-m-d', $v["addtime"])); ?>]</a></span></li><?php endforeach; endif; ?>
							<?php else: ?>暂无内容<?php endif; ?>
						</ul>
					</div>
			</div>
		</div>
		...
		<!---第一行--->
		<div class="xuanzhi">
			<div class="cehua_read"><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'2'));?>"><img src="__PUBLIC__/images/images/huiyi_more_read.jpg"/></a></div>
			<div class="huiyi_neir">
				<div class="huiyi_img"><img src='<?php if($cehua["0"]["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($cehua["0"]["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></div>
					<div class="huiyi_list">
						<ul>
						<?php if($cehua): if(is_array($cehua)): foreach($cehua as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Category/cateShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a><span><a href="">[<?php echo (date('Y-m-d', $v["addtime"])); ?>]</a></span></li><?php endforeach; endif; ?>
							<?php else: ?>暂无内容<?php endif; ?>
						</ul>
					</div>
			</div>
		...
		<!---第一行--->
		<div class="xuanzhi">
			<div class="jiedai_read"><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'3'));?>"><img src="__PUBLIC__/images/images/huiyi_more_read.jpg"/></a></div>
			<div class="huiyi_neir">
				<div class="huiyi_img"><img src='<?php if($jiedai["0"]["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($jiedai["0"]["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></div>
					<div class="huiyi_list">
						<ul>
							<?php if($jiedai): if(is_array($jiedai)): foreach($jiedai as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Category/cateShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a><span><a href="">[<?php echo (date('Y-m-d', $v["addtime"])); ?>]</a></span></li><?php endforeach; endif; ?>
								<?php else: ?>暂无内容<?php endif; ?>
						</ul>
					</div>
			</div>
		...
		<!---第一行--->
		<div class="xuanzhi">
			<div class="jiudian_read"><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'4'));?>"><img src="__PUBLIC__/images/images/huiyi_more_read.jpg"/></a></div>
			<div class="huiyi_neir">
				<div class="huiyi_img"><img src='<?php if($jiudian["0"]["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($jiudian["0"]["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></div>
					<div class="huiyi_list">
						<ul>
							<?php if($jiudian): if(is_array($jiudian)): foreach($jiudian as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Category/cateShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a><span><a href="">[<?php echo (date('Y-m-d', $v["addtime"])); ?>]</a></span></li><?php endforeach; endif; ?>
								<?php else: ?>暂无内容<?php endif; ?>
						</ul>
					</div>
			</div>
		...
		<!---第一行--->
		<div class="xuanzhi">
			<div class="sheshi_read"><a href="<?php echo U(GROUP_NAME.'/Category/cateList', array('fenlei' =>'5'));?>"><img src="__PUBLIC__/images/images/huiyi_more_read.jpg"/></a></div>
			<div class="huiyi_neir">
				<div class="huiyi_img"><img src='<?php if($sheshi["0"]["max"]): ?>__ROOT__/uploads/Pic/<?php echo ($sheshi["0"]["max"]); ?>
                        <?php else: ?>
                            __PUBLIC__/images/images/pic.jpg<?php endif; ?>'/></div>
					<div class="huiyi_list">
						<ul>
							<?php if($sheshi): if(is_array($sheshi)): foreach($sheshi as $key=>$v): ?><li><a href="<?php echo U(GROUP_NAME.'/Category/cateShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a><span><a href="">[<?php echo (date('Y-m-d', $v["addtime"])); ?>]</a></span></li><?php endforeach; endif; ?>
								<?php else: ?>暂无内容<?php endif; ?>
						</ul>
					</div>
			</div>
