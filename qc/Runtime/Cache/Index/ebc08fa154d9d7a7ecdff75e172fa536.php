<?php if (!defined('THINK_PATH')) exit();?><title><?php echo ($_COOKIE['user']); ?>-<?php echo ($list["0"]["type"]); ?>订单管理</title>
...
<!--左侧 end-->
	<div class="huiy_right">
		<div class="right_ziliao_bj"><span><?php echo ($list["0"]["type"]); ?></span></div>
    ...
    <tbody>
		<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php if(($v["bookstatus"]) == "0"): ?><a href="<?php echo U(GROUP_NAME.'/IndexUser/saveBook',array('id'=>$v['id']));?>" class="ajax-get"><img src="__PUBLIC__/images/images/save.png"style="width:15px;"/></a>
				<?php else: endif; ?>
