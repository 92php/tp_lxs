...
<input name="btn" type="button" id="btn" onClick="toDesktop('http:\//baidu.com/','五台山青春旅行社')">
</head>
<body>
...
<div class="register">
	...
	<div class="register_inpt">
		<form action="<?php echo U(GROUP_NAME.'/Index/runRegis');?>" method="post" name="register">
			<ul>
				<li><span>常用邮箱：</span><input type='text' name="email"  id="email"/><span id="lei"><a href="">&nbsp;以后用于登录用户名</a></span></li>
				<li><span>设置密码：</span><input type='password' name="pwd" id="pwd" /><span id="lei"><a href="">&nbsp;6位以上字符</a></span></li>
				<li><span>确认密码：</span><input type='password' name="repwd" /><span id="lei"><a href="">&nbsp;俩次密码必须一致</a></span></li>
				<li><span>手机号码：</span><input type='text' name="phone" /><span id="lei"><a href="">&nbsp;方便我们为您提供更加完善的服务</a></span></li>
				<li><span>真实姓名：</span><input type='text' name="name" id="yzm"/></li>
				<li><span>性　　别：</span><input type="radio" name="sex" id="sexm" value="1" checked="checked"/>男<input type="radio" name="sex" id="sexw"  value="0"/>女</li>
				<li><span>Q　Q号码：</span><input type='text' name="qq" /></li>
