...
<div class="hotel">
	...
	<!--内容 start-->
		...
		<?php if(is_array($Budd)): $i = 0; $__LIST__ = $Budd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!--第一行start-->
			<div class="list_line">
				...
				<div class="list_line_word">
					<h2><a href="<?php echo U(GROUP_NAME.'/Buddhist/buddShow', array('id' => $v['id']));?>"><?php echo ($v["title"]); ?></a></h2>
					<p><?php echo ($v["about"]); ?></p>
					<a href="<?php echo U(GROUP_NAME.'/Buddhist/buddShow', array('id' => $v['id']));?>" class="button">查看详情>></a>
				</div>
			</div>
		<!--第一行end--><?php endforeach; endif; else: echo "" ;endif; ?>
		<!-----------分页start---------->
